...
export default function Search() {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={[{  }]} >
                <TouchableOpacity style={{ backgroundColor: '#383838', padding: 10, borderRadius: 10, height: 40, justifyContent: "center", width: "75%", alignSelf: "center" }}>
                    <Text style={{ color: '#F9CC00', textAlign: "center",   fontWeight: "bold"}}>Buscar recetas</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
